'''
conexion a AZURE y uso de Polars
...
# public = "data/"
public = "https://vgclabdata.blob.core.windows.net/public/"
df = pl.read_csv(public+"dataset_maceda.csv", sep=",")
# try:
...
# sacar columnasS
df = df.drop(['id_evento_relacionado', 'fecha_reportada'])

df = df.rename({'ubicacion_tipo': 'ubicacion',
...
df['fecha'] = pl.to_datetime(df['fecha'], format='%Y-%m-%d')
